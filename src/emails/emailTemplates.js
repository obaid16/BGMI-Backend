...
const getBaseUrl = () => {
  const url = process.env.FRONTEND_URL || (process.env.CLIENT_URL && !process.env.CLIENT_URL.includes('localhost') ? process.env.CLIENT_URL : null) || 'https://bgmi-frontend-pied.vercel.app';
  return url.replace(/\/$/, '');
};
